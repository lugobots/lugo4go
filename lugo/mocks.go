...
// Source: github.com/lugobots/lugo4go/v2/lugo (interfaces: PlayerOrder,GameServer,GameClient,Game_JoinATeamClient,Game_JoinATeamServer,BroadcastClient,Broadcast_OnEventClient,BroadcastServer,Broadcast_OnEventServer,Logger)
...
func (m *MockBroadcastClient) OnEvent(arg0 context.Context, arg1 *empty.Empty, arg2 ...grpc.CallOption) (Broadcast_OnEventClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(Broadcast_OnEventClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Recv mocks base method
func (m *MockBroadcast_OnEventClient) Recv() (*GameEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*GameEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// OnEvent mocks base method
func (m *MockBroadcastServer) OnEvent(arg0 *empty.Empty, arg1 Broadcast_OnEventServer) error {
	m.ctrl.T.Helper()
...
// Send mocks base method
func (m *MockBroadcast_OnEventServer) Send(arg0 *GameEvent) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", arg0)
	ret0, _ := ret[0].(error)
	return ret0
