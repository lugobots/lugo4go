...
// Source: github.com/lugobots/lugo4go/v2/proto (interfaces: PlayerOrder,GameServer,GameClient,Game_JoinATeamClient,Game_JoinATeamServer,BroadcastClient,Broadcast_OnEventClient,BroadcastServer,Broadcast_OnEventServer)
