...
// Source: github.com/lugobots/lugo4go/v3/proto (interfaces: PlayerOrder,GameServer,GameClient,Game_JoinATeamClient,Game_JoinATeamServer,BroadcastClient,Broadcast_OnEventClient,BroadcastServer,Broadcast_OnEventServer)
...
func (m *MockGame_JoinATeamServer) Send(arg0 *proto.GameSnapshot) error {
	m.ctrl.T.Helper()
...
func (m *MockBroadcastClient) GetGameSetup(arg0 context.Context, arg1 *proto.WatcherRequest, arg2 ...grpc.CallOption) (*proto.GameSetup, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockBroadcastClient) OnEvent(arg0 context.Context, arg1 *proto.WatcherRequest, arg2 ...grpc.CallOption) (proto.Broadcast_OnEventClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(proto.Broadcast_OnEventClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Recv mocks base method.
func (m *MockBroadcast_OnEventClient) Recv() (*proto.GameEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*proto.GameEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetGameSetup mocks base method.
func (m *MockBroadcastServer) GetGameSetup(arg0 context.Context, arg1 *proto.WatcherRequest) (*proto.GameSetup, error) {
	m.ctrl.T.Helper()
...
// OnEvent mocks base method.
func (m *MockBroadcastServer) OnEvent(arg0 *proto.WatcherRequest, arg1 proto.Broadcast_OnEventServer) error {
	m.ctrl.T.Helper()
...
// Send mocks base method.
func (m *MockBroadcast_OnEventServer) Send(arg0 *proto.GameEvent) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", arg0)
	ret0, _ := ret[0].(error)
	return ret0
