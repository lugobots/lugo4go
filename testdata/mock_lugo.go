...
// Source: github.com/lugobots/client-player-go/v2/lugo (interfaces: Client,Logger,OrderSender)
...
import (
	...
	lugo "github.com/lugobots/client-player-go/v2/lugo"
...
func (m *MockClient) OnNewTurn(arg0 lugo.DecisionMaker, arg1 lugo.Logger) {
	m.ctrl.T.Helper()
...
func (m *MockClient) SenderBuilder(arg0 func(*proto.GameSnapshot, lugo.Logger) lugo.OrderSender) {
	m.ctrl.T.Helper()
