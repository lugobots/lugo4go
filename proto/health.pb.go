...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=lugo.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_health_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x67, 0x6f, 0x22, 0x2e, 0x0a, 0x12, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68,
	...
	0x76, 0x69, 0x63, 0x65, 0x22, 0xa7, 0x01, 0x0a, 0x13, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43,
	...
	0x75, 0x67, 0x6f, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52,
	...
	,
...
var file_health_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: lugo.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: lugo.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: lugo.HealthCheckResponse
}
var file_health_proto_depIdxs = []int32{
	0, // 0: lugo.HealthCheckResponse.status:type_name -> lugo.HealthCheckResponse.ServingStatus
	1, // 1: lugo.Health.Check:input_type -> lugo.HealthCheckRequest
	1, // 2: lugo.Health.Watch:input_type -> lugo.HealthCheckRequest
	2, // 3: lugo.Health.Check:output_type -> lugo.HealthCheckResponse
	2, // 4: lugo.Health.Watch:output_type -> lugo.HealthCheckResponse
...
func (c *healthClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lugo.Health/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healthClient) Watch(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (Health_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Health_serviceDesc.Streams[0], "/lugo.Health/Watch", opts...)
	if err != nil {
		return nil, err
	}
