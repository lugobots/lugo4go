...
//	state, err = DefineMyState(lugo.Config{Number: 3, TeamSide: lugo.Team_HOME}, snapshot)
//	assert.Nil(t, err)
//	assert.Equal(t, DisputingTheBall, state)
//
//	state, err = DefineMyState(lugo.Config{Number: 5, TeamSide: lugo.Team_HOME}, snapshot)
//	assert.Nil(t, err)
//	assert.Equal(t, DisputingTheBall, state)
//
//	state, err = DefineMyState(lugo.Config{Number: 5, TeamSide: lugo.Team_AWAY}, snapshot)
//	assert.Nil(t, err)
//	assert.Equal(t, DisputingTheBall, state)
//
//	ball.Holder = home3
...
//	var err error
//
//	_, err = DefineMyState(lugo.Config{Number: 3, TeamSide: lugo.Team_HOME}, nil)
//	assert.Equal(t, err, ErrNoBall)
//
//	_, err = DefineMyState(lugo.Config{Number: 3, TeamSide: lugo.Team_HOME}, &lugo.GameSnapshot{})
//	assert.Equal(t, err, ErrNoBall)
//}
//
...
//	var err error
//
//	_, err = DefineMyState(lugo.Config{Number: 3, TeamSide: lugo.Team_HOME}, &lugo.GameSnapshot{Ball: &lugo.Ball{}})
...
//	mockSender := lugo4go.NewMockOrderSender(ctrl)
//
//	config := lugo.Config{Number: 1, TeamSide: lugo.Team_HOME}
//
//	defaultHandler := DefaultTurnHandler(mockDecider, config, nil)
//
//	ctx, stop := context.WithTimeout(context.Background(), 1*time.Second)
