...
func (m *MockBot) OnDisputing(ctx context.Context, sender OrderSender, snapshot *lugo.GameSnapshot) error {
	m.ctrl.T.Helper()
...
func (m *MockBot) OnDefending(ctx context.Context, sender OrderSender, snapshot *lugo.GameSnapshot) error {
	m.ctrl.T.Helper()
...
func (m *MockBot) OnHolding(ctx context.Context, sender OrderSender, snapshot *lugo.GameSnapshot) error {
	m.ctrl.T.Helper()
...
func (m *MockBot) OnSupporting(ctx context.Context, sender OrderSender, snapshot *lugo.GameSnapshot) error {
	m.ctrl.T.Helper()
...
func (m *MockBot) AsGoalkeeper(ctx context.Context, sender OrderSender, snapshot *lugo.GameSnapshot) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AsGoalkeeper", ctx, sender, snapshot)
	ret0, _ := ret[0].(error)
	return ret0
}

// AsGoalkeeper indicates an expected call of AsGoalkeeper
func (mr *MockBotMockRecorder) AsGoalkeeper(ctx, sender, snapshot interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AsGoalkeeper", reflect.TypeOf((*MockBot)(nil).AsGoalkeeper), ctx, sender, snapshot)
}
...
func (m *MockPositioner) GetRegion(col, row uint8) (Region, error) {
	m.ctrl.T.Helper()
...
func (m *MockPositioner) GetPointRegion(point lugo.Point) (Region, error) {
	m.ctrl.T.Helper()
...
func (m *MockRegion) Front() Region {
	m.ctrl.T.Helper()
...
func (m *MockRegion) Right() Region {
	m.ctrl.T.Helper()
