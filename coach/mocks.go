...
func (m *MockDecider) OnDisputing(ctx context.Context, data TurnData) error {
	m.ctrl.T.Helper()
...
func (m *MockDecider) OnDefending(ctx context.Context, data TurnData) error {
	m.ctrl.T.Helper()
...
func (m *MockDecider) OnHolding(ctx context.Context, data TurnData) error {
	m.ctrl.T.Helper()
...
func (m *MockDecider) OnSupporting(ctx context.Context, data TurnData) error {
	m.ctrl.T.Helper()
...
func (m *MockDecider) AsGoalkeeper(ctx context.Context, data TurnData) error {
	m.ctrl.T.Helper()
